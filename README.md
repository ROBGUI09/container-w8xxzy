...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-w8xxzy.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-w8xxzy.containers.anotherwebservice.com/
...
```
git clone git@github.com:ROBGUI09/container-w8xxzy.git
cd container-w8xxzy
```
...
```
docker attach container-w8xxzy
```
